...
public class Task4 {
    public static void main(String[] args) {
        ...
        "public int fixTeen(int n) {" that takes in an int value and returns that value fixed for the teen rule.In this way, you
        ...
        */
        ...
        System.out.println(task.noTeenSum(2, 13, 1));
